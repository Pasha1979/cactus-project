...
import '../utils/responsive_helper.dart'; // ← Новый импорт
import 'dart:async';
...
class MyApp extends StatelessWidget {
  ...
  Future<void> _performAutoSync(
    ...
    try {
      ...
      // 2. Выполняем полную двустороннюю синхронизацию через новый метод
...
class HomeScreenState extends State<HomeScreen>
  ...
  String? _selectedSowingYear; // Новый: для фильтра по году посева
  // === Поиск ===
...
/*
  ...
  */
  ...
  // Новый метод: Показывает диалог с выбором года посева
